<footer class="page-footer">
         ...
         <div class="footer-copyright">
           ...
           <a class="grey-text text-lighten-4 right animated slideInUp wow" href="github.com/jacobjohn2016"><i class="fa fa-heartbeat animated pulse infinite red-text"></i> Reproduced for Educational Purposes. Original work by Ismail Ghallou</a>
           </div>
         </div>
       </footer>
